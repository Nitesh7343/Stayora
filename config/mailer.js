...
async function sendOtpEmail({ to, code }) {
  ...
  const subject = "Your Stayora verification code";
  const textContent = `Your Stayora verification code is: ${code}\n\nThis code expires in 10 minutes.`;
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; line-height: 1.5">
      <h2 style="margin: 0 0 8px">Verify your email</h2>
      <p style="margin: 0 0 12px">Your Stayora verification code is:</p>
  ...
  sendSmtpEmail.sender = { 
    name: EMAIL_FROM_NAME || "Stayora", 
    email: EMAIL_FROM_ADDRESS || "noreply@stayora.com" 
  };
